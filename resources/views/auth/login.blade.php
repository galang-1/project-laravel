...
/* Override guest layout container — make it full viewport */
body {
    background: var(--cream) !important;
    font-family: 'DM Sans', sans-serif !important;
}

/* Hide the default guest layout wrapper if it adds padding/card */
...
.field .text-red-600,
.field .text-sm { font-size: 11px !important; margin-top: 5px; }
...
<div class="auth-wrapper">
    ...
    <div class="auth-panel">
        ...
        <div class="panel-body">
            <h2>Kelola keuangan dengan lebih <em>cerdas</em></h2>
            <p>Pantau pemasukan, pengeluaran, dan anggaran Anda dalam satu dasbor yang elegan.</p>
        </div>
    </div>
